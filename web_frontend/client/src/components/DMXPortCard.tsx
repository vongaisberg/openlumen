          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value={PortMode.Input}>Input</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
        ...
        {isInputMode && (
          <div className="border-t border-border pt-4">
            <p className="text-sm text-muted-foreground">
              Receiving DMX frames and broadcasting as ArtDMX on universe {port.universe}.
            </p>
          </div>
        )}
